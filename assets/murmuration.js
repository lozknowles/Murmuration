(() => {
   ...
   *
   * Each update is two-phase: every bird reads the same shared flock state,
   ...
   * Front-to-back coordinates use an expanded projection to give the flock a
   * broad visual depth without changing its calibrated flight velocity.
   */
